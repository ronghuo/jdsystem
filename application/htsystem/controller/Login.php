...
class Login extends Common
{
    ...
    protected function login(Request $request){
        ...
        $user = Admins::field('ID AS USER_ID,LOG,PWD,STAT,ROLE_ID,NAME,MOBILE,GENDER,STATUS,LOGINIP,LGTIME,POWER_COMMUNITY_ID,POWER_STREET_ID,POWER_COUNTY_ID_12,POWER_CITY_ID,DMMCIDS')
